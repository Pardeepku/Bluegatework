  ...
  const sections = [
    ...
    },
    {
      ...
      items: [
        ...
        {
          title: 'For Jobseekers (Careers & Placements)',
          url: '/for-jobseekers',
          slug: 'for-jobseekers',
          pageId: 'for-jobseekers' as PageId,
          description: 'European employment pathways across Portugal and Netherlands, housing benefits, and candidate applications.',
          priority: '0.9',
          changefreq: 'Weekly',
        },
      ],

...
export const HomePage: React.FC<HomePageProps> = ({
  ...
  return (
    <div className="space-y-20 sm:space-y-24 pb-16 overflow-hidden">
      {/* 1. HERO 2-SLIDE SLIDER SECTION - 100% WIDTH ON PC */}
      {hp.showHeroSlider !== false && (
        <section className="relative pt-0 pb-12 overflow-hidden bg-gradient-to-br from-white via-white to-[#eef6ff]">
          {/* Main 2 Slide Slider spanning full 100% width */}
                ...
                >
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <h3 className="font-bold text-[#002366] text-base group-hover:text-[#0056b3] transition-colors">
                        {hp.quickCard1Title || 'Temporary Staffing'}
                      </h3>
                    </div>
                  </div>
                  <p className="text-xs text-slate-500 leading-snug">
                    {hp.quickCard1Desc || 'Comprehensive flexible workforce solutions tailored to shift and seasonal surge needs in Portugal and Netherlands.'}
                  </p>
                </div>
                ...
                >
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <h3 className="font-bold text-[#002366] text-base group-hover:text-[#0056b3] transition-colors">
                        {hp.quickCard2Title || 'Workforce Outsourcing'}
                      </h3>
                    </div>
                  </div>
                  <p className="text-xs text-slate-500 leading-snug">
                    {hp.quickCard2Desc || 'Strategic production line & facility management with on-site coordinators allowing you to focus on core growth.'}
                  </p>
                </div>
                ...
                >
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <h3 className="font-bold text-[#002366] text-base group-hover:text-[#0056b3] transition-colors">
                        {hp.quickCard3Title || 'International Recruitment'}
                      </h3>
                    </div>
                  </div>
                  <p className="text-xs text-slate-500 leading-snug">
                    {hp.quickCard3Desc || 'Cross-border sourcing bridging European industries with certified talent in Eastern Europe, Asia, and Latin America.'}
                  </p>
                </div>
              </div>
            </div>
        ...
        <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-12">
          <div className="text-center max-w-3xl mx-auto space-y-3">
            ...
            <h2 className="text-3xl sm:text-4xl font-black text-[#002366] font-heading tracking-tight">
              {hp.servicesHeading || 'Tailored Staffing Solutions Built for Speed & Compliance'}
            </h2>
            <p className="text-slate-600 text-sm sm:text-base">
              {hp.servicesSubheading || 'Whether you need rapid temporary reinforcement in 48 hours, fully managed line outsourcing, or cross-border skilled recruitment, Bluegate Work delivers with guaranteed quality.'}
            </p>
          </div>
              ...
              >
                ...
                <div className="pt-6 mt-6 border-t border-blue-50 flex items-center justify-between">
                  ...
                  <button
                    ...
                    className="inline-flex items-center gap-1.5 text-xs font-bold text-[#002366] hover:text-[#0056b3] group-hover:translate-x-1 transition-transform cursor-pointer"
                  >
      ...
      {hp.showIndustriesSection !== false && (
        <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-12">
          <div className="flex flex-col sm:flex-row items-start sm:items-end justify-between gap-4">
            <div className="space-y-2 max-w-2xl">
              ...
              <h2 className="text-3xl sm:text-4xl font-black text-slate-950 font-heading tracking-tight">
                {hp.industriesHeading || 'Sectors We Power Across Portugal & Netherlands'}
              </h2>
              <p className="text-slate-600 text-sm">
                {hp.industriesSubheading || 'Supplying certified operators, seasoned technicians, and managed teams tailored to strict sector standards.'}
              </p>
            </div>

            <button
              onClick={() => onNavigate('industries')}
              className="px-5 py-2.5 rounded-xl border border-slate-300 hover:border-slate-900 font-bold text-xs text-slate-800 transition-colors flex items-center gap-1.5 shrink-0 cursor-pointer"
            >
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 space-y-12">
            ...
            <div className="text-center pt-4">
              <button
                ...
                className="px-6 py-3 rounded-xl bg-white text-[#1E40AF] font-bold text-xs hover:bg-blue-50 transition-colors inline-flex items-center gap-2 shadow-lg cursor-pointer"
              >
      ...
      {hp.showProcessSection !== false && (
        <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-12">
          <div className="text-center max-w-3xl mx-auto space-y-3">
            ...
            <h2 className="text-3xl sm:text-4xl font-black text-slate-950 font-heading tracking-tight">
              {hp.processHeading || 'How We Deliver 100% Reliable Workforce'}
            </h2>
            <p className="text-slate-600 text-sm">
              {hp.processSubheading || 'From first audit to daily on-site supervision, our 4-stage pipeline guarantees zero administrative burden and complete labor legal protection.'}
            </p>
          </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
              <div className="lg:col-span-5 space-y-3">
                ...
                <h3 className="text-2xl sm:text-3xl font-extrabold font-heading text-white">
                  {hp.complianceHeading || 'The Bluegate Compliance Shield'}
                </h3>
                <p className="text-slate-400 text-xs sm:text-sm leading-relaxed">
                  {hp.complianceSubheading || 'Cross-border labor laws in Europe are stringent. We guarantee complete legal compliance with Portuguese ACT standards, Dutch SNA guidelines, and the European Posting of Workers Directive, fully protecting your company from joint liability.'}
                </p>
              </div>
        ...
        <section className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 space-y-8">
          <div className="text-center space-y-2">
            ...
            <h2 className="text-2xl sm:text-3xl font-black text-slate-950 font-heading tracking-tight">
              {hp.faqHeading || 'Clear Answers to Common Workforce Inquiries'}
            </h2>
          </div>
              ...
              return (
                ...
                >
                  <button
                    ...
                    className="w-full text-left p-5 flex items-center justify-between gap-4 font-bold text-xs sm:text-sm text-slate-900 hover:text-[#1E40AF] cursor-pointer"
                  >

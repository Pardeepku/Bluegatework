...
export const DEFAULT_HEADER_CONFIG = {
  ...
  showNavEmployers: true,
  showNavJobseekers: true,
  showNavBlog: true,
  showNavLocations: true,
  showNavAbout: true,
  showNavContact: true,
...
export const DEFAULT_FOOTER_CONFIG = {
  showCtaBanner: true,
  ctaBannerBadge: 'Verified European Workforce Ready in 48-72h',
  ctaBannerHeading: 'Need Qualified Workers in Portugal, Netherlands or Europe?',
  ctaBannerSubtext: 'Get an instant headcount assessment and compliance roadmap tailored to your industry, seasonal surges, or turnkey operational outsourcing.',
  ctaButtonText: 'Request Staffing Proposal',
  ctaWhatsAppText: 'Chat on WhatsApp',
  showAboutColumn: true,
  aboutTitle: 'About Bluegate Work',
  ...
  showIndustriesSublist: true,
  industriesTitle: 'European Sectors',
  showQuickLinksColumn: true,
  quickLinksTitle: 'Company & Hubs',
  showLicensingBox: true,
  licensingBoxTitle: 'Licensed Provider',
  licensingBoxText: 'Fully licensed Temporary Work Agency (ETT) & Certified European Cross-Border Workforce Provider',
  showCallbackColumn: true,
  callbackTitle: 'Fast Callback Request',
  callbackSubtext: 'Enter your phone number and our European workforce deployment team will call you within 30 minutes.',
  callbackPlaceholder: '+351 920 132 915',
  callbackResponseTime: 'Guaranteed response in 30 minutes',
  showOperatingHours: true,
  operatingHoursTitle: 'Operational Office Hours',
  operatingHours: 'Mon - Fri: 08:30 - 18:30 CET (24/7 Emergency On-call support for active client deployments)',
  showCopyrightBar: true,
  copyrightText: 'All rights reserved. Registered in Portugal.',
  showFooterCertifications: true
};

export const DEFAULT_HOME_PAGE_CONTENT = {
  showHeroSlider: true,
  showHeroQuickCards: true,
